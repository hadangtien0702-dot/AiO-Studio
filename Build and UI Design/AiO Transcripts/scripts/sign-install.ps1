# =====================================================================
#  AiO Studio TRANSCRIPT - sign-install.ps1
...
$extId    = 'com.aiostudio.transcript'
...
$zxpOut   = Join-Path $root 'build\aio-transcript.zxp'
$cepExt   = Join-Path $env:APPDATA 'Adobe\CEP\extensions'
$target   = Join-Path $cepExt $extId

Write-Host "AiO Studio Transcript - sign & install" -ForegroundColor Cyan
