...
export default function App() {
  ...
  // [2.0.0] Tách sản phẩm: panel này CHỈ còn Asset Manager, nên mở ra là vào
  // thẳng lưới asset. Màn hình chào 2 thẻ đã bỏ — Power Bins nay là panel riêng
  // (com.aiostudio.powerbin), cài và bán độc lập.
  return (
    <div className="app">
      <Toolbar />
