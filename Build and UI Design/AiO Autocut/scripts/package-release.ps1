...
$lines = @(
  ...
  "",
  "  DA KIEM: 19/08/2026 tac gia tu dung mot bai that roi NGHE LAI - khong mat",
  "  loi. Pham vi da xac nhan: talking-head MOT nguoi, giong Viet, thu gan mic.",
  "",
  "  CHUA do trong ba ca sau, chay thi nen nghe lai truoc khi giao hang:",
  "    - hai nguoi tro len, co nguoi ngoi XA MIC",
  "    - clip co nhac nen hoac phong on",
  "    - video dai tren 30 phut",
  "  Lan dau chay tren bai that: chon Sequence moi cho chac (ban goc con nguyen)."
)
