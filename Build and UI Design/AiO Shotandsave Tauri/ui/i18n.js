'use strict'
/* Boc IIFE (ban Tauri): `function t` o day tung DUNG TEN voi `const t` cua
   overlay.js khi cung nap vao mot trang — ben Electron i18n chi song trong
   preload nen khong dung. */
;(function () {
...
/* Ban Tauri: file nay nap thang bang <script> trong webview (khong CommonJS).
   NOI DUNG TU DIEN GIU NGUYEN 100% tu ban Electron — chi doi dong xuat. */
window.AIO_I18N = { DICH, t }
})()
