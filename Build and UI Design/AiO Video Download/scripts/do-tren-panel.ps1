# =============================================================================
#  do-tren-panel.ps1 - Chay JavaScript THANG TREN PANEL Video Download dang mo trong Premiere.
# =============================================================================
#  Dung de KIEM CHUNG BANG SO thay vi doan: doc DOM, goi evalScript sang host,
#  lay duong dan media that cua du an dang mo.
#
#  Dieu kien: dang cai ban DEV (co file .debug mo cong 8098 cho Video Download).
#  8088-8097 da co chu - moi panel mot cong.
#
#  Vi du:
