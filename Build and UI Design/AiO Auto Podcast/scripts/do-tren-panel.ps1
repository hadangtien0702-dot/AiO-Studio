# =============================================================================
#  do-tren-panel.ps1 - Chay JavaScript THANG TREN PANEL Auto Podcast dang mo trong Premiere.
# =============================================================================
#  Dung de KIEM CHUNG BANG SO thay vi doan: doc DOM, goi evalScript sang host,
#  lay duong dan media that cua du an dang mo.
#
#  Dieu kien: dang cai ban DEV (co file .debug mo cong 8094 cho Auto Podcast).
#  8088 Asset - 8089 Autocut - 8090 PowerBins - 8091 Transcripts - 8092 ReFrames.
#
#  Vi du:
