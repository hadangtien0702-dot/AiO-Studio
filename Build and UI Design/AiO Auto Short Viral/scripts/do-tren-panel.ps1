# =============================================================================
#  do-tren-panel.ps1 - Chay JavaScript THANG TREN PANEL Auto Short Viral dang mo trong Premiere.
# =============================================================================
#  Dung de KIEM CHUNG BANG SO thay vi doan: doc DOM, goi evalScript sang host,
#  lay duong dan media that cua du an dang mo.
#
#  Dieu kien: dang cai ban DEV (co file .debug mo cong 8100 cho Auto Short Viral)
#  VA panel dang MO trong Premiere - dong panel la cong chet.
#  Moi panel mot cong (bang cong: AiO Studio\CLAUDE.md muc 2).
#
#  Vi du:
#    .\scripts\do-tren-panel.ps1 -Expression "document.title"
#    .\scripts\do-tren-panel.ps1 -Expression "new Promise(r=>new CSInterface().evalScript('app.project.name',r))"
#
