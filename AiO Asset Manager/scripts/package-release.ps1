...
@'
# Cai AiO Studio - Asset Manager vao Adobe Premiere Pro.
...
$target = Join-Path $env:APPDATA 'Adobe\CEP\extensions\com.aiostudio.assetmanager'
...
@'
@echo off
title AiO Studio - Asset Manager : Cai dat
echo.
echo    AiO Studio - Asset Manager
echo    ==========================
echo.
