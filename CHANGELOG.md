...
> (Shot & Save). Bản đã có bộ cài thì ghi `Release/<app>/win/` (chỉ giữ bản mới nhất). Bản anh Tiến
...
| Ngày | Bản | Cập nhật | Chấm |
|---|:-:|---|:-:|
| 14/09 | **0.4.17** | Thư mục mặc định `%LOCALAPPDATA%\shotandsave`, file `shotandsave-…`; **kéo-thả an toàn**: đường dẫn có `&`/dấu cách/ký tự lạ thì kéo qua hard link `.keo` (người dùng chọn thư mục gì cũng kéo được vào Chrome/Lark/Teams/Zalo). Unit 4/4, selftest 5/5. Anh: *"kéo ầm ầm rồi"*. 📦 `Release/AiO Shotandsave/win/` | ✅ anh chấm |
...
| 31/08 | 0.4.2 | Kéo-và-giữ hết giật: neo = điểm mousedown renderer gửi kèm. 📦 (đã thay bằng bản mới hơn). Anh: *"kéo lại ổn định"* | ✅ anh chấm |
